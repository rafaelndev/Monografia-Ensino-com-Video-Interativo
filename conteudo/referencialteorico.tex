...
\subsection{VIDEO.JS}
O \citeonline{videojs}, é uma biblioteca de \textit{Javascript} e \textit{CSS} que facilita trabalhar e construir vídeos \textit{HTML5}.
...
Segundo \citeonline[p.~321]{martin_fowler_patterns} o \textit{MVC} consiste em três regras, são elas:
